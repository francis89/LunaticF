package spring.utility.lfinder;
...
//		int cnt = 0;
//		if(type.equals("bbs")){
//			ReplyDAO rdao = (ReplyDAO)obj;
//			cnt = rdao.rcount(no);
//		} else if(type.equals("memo")){
//			MreplyDAO rdao = (MreplyDAO)obj;
//			cnt = rdao.rcount(no);
//		}
//		return cnt;
//    }
...
/*	public static String getCodeValue(String code) {
	...
	public static String paging1(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		if (nowGrp >= 2) {
			str.append("<ul class='pager'><li><A href='./list.jsp?col=" + col + "&word=" + word + "&nowPage=" + _nowPage
					+ "'>이전</A></li></ul>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<ul class='pagination'><li><A href='./list.jsp?col=" + col + "&word=" + word + "&nowPage="
						+ i + "'>" + i + "</A></li></ul>");
			}
		}
	 ...
	 * @return 페이징 생성 문자열
	 */
	public static String paging(int totalRecord, int nPage, int recordPerPage, String url,String noName ,int no, int nowPage,
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&"+noName+"=" + no + "&nPage=" + _nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col
						+ "&word=" + word + "&"+noName+"="  + no + "&nPage=" + i + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&"+noName+"="  + no + "&nPage=" + _nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
